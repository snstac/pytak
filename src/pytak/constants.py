...
DEFAULT_RECONNECT_INITIAL: str = "5"
DEFAULT_RECONNECT_FACTOR: str = "2"
DEFAULT_RECONNECT_JITTER: str = "0.2"
DEFAULT_RECONNECT_RESET: str = "300"
DEFAULT_SLEEP: str = "5"
...
DEFAULT_TAK_STREAMING_PORT: int = 8089
DEFAULT_TAK_ENROLLMENT_PORT: int = 8446
DEFAULT_CERT_CACHE_BUFFER_DAYS: int = 7

DEFAULT_MARTI_PORT: int = 8443
DEFAULT_MARTI_POLL_INTERVAL: int = 5
DEFAULT_MARTI_POLL_SECONDS_AGO: int = 30

DEFAULT_WS_PATH: str = "/takproto/1"
DEFAULT_WS_PORT: int = 8443

DEFAULT_MQTT_PORT: int = 1883
DEFAULT_MQTTS_PORT: int = 8883
DEFAULT_MQTT_QOS: int = 0
DEFAULT_MQTT_KEEPALIVE: int = 60
